            ...
            <div class="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                ...
                <div class="md:col-span-8 lg:col-span-9 space-y-4 text-center md:text-left">
                    ...
                    <div class="pt-3 flex flex-wrap items-center justify-center md:justify-start gap-3">
                        ...
                        @if($featuredBook->chapters()->where('is_published', true)->exists())
                            <a href="{{ route('books.pdf', $featuredBook->id) }}" 
                               class="px-5 py-3 bg-rose-500/10 hover:bg-rose-500/20 text-rose-300 font-semibold text-xs uppercase tracking-wider rounded-xl border border-rose-500/30 hover:border-rose-400/50 transition-all active:scale-[0.98] flex items-center gap-2"

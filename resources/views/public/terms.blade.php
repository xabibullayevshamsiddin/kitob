...
<body class="bg-ink-950 text-slate-200 font-sans antialiased min-h-screen">
    ...
    <main class="py-16 max-w-4xl mx-auto px-6 space-y-8">
        <div>
            ...
            <h1 class="text-3xl sm:text-4xl font-extrabold text-white mt-2">Foydalanish Shartlari</h1>
        ...
        <div class="prose prose-invert max-w-none text-sm text-slate-300 space-y-6 leading-relaxed">
            <p>1. <strong>Umumiy qoidalar:</strong> Kitobxon platformasida ro'yxatdan o'tish orqali siz haftalik mutolaa qoidalariga va hamjamiyat etikasiga rioya qilishga rozilik bildirasiz.</p>
            <p>2. <strong>Mualliflik huquqi:</strong> Platformadagi barcha matnlar, audio yozuvlar va video tahlillar mualliflik huquqi bilan himoyalangan. Ularni ruxsatsiz tijoriy maqsadda nusxalash taqiqlanadi.</p>
            <p>3. <strong>Hamjamiyat va chat etikasi:</strong> Global chat va guruhlarda boshqa kitobxonlarga nisbatan hurmatsizlik, nojo'ya so'zlar va reklama tarqatish qat'iyan man etiladi.</p>
        </div>
    </main>
</body>
</html>

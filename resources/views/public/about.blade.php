    ...
    <div :class="scrolled ? 'glass shadow-soft' : 'bg-transparent'" class="transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <nav class="hidden lg:flex items-center gap-8">
                    ...
                    <a href="/about" class="nav-link text-indigo-600 dark:text-indigo-400 font-semibold transition-colors duration-200">Haqimizda</a>
        ...
        <div x-show="mobileMenu" x-cloak
            ...
            <div class="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-2">
                ...
                <a href="/about" class="px-4 py-3 rounded-xl bg-indigo-50 dark:bg-indigo-950 font-semibold text-indigo-600 dark:text-indigo-400 transition-colors">Haqimizda</a>
        ...
        <div class="mt-16 observe-animate">
            <div class="relative p-10 bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-indigo-950/30 dark:to-violet-950/30 rounded-3xl border border-indigo-100 dark:border-indigo-900 text-center overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <a href="/contact" class="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl transition-all duration-300 hover:scale-105 shadow-glow hover:shadow-none">
                        📧 Murojaat yuborish
                    </a>
                </div>
            </div>
...
<section class="py-20 bg-gradient-to-br from-indigo-900 via-violet-900 to-slate-900 relative overflow-hidden">
    ...
    <div class="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center observe-animate">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="/register" class="w-full sm:w-auto px-8 py-4 font-bold text-indigo-900 bg-white rounded-2xl hover:bg-indigo-50 shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-1">🚀 Hoziroq Boshlang</a>
            <a href="/contact" class="w-full sm:w-auto px-8 py-4 font-bold text-white bg-white/10 backdrop-blur rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:-translate-y-1">📧 Bog'laning</a>
        </div>
    </div>
</section>
